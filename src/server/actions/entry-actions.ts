...
const entrySchema = z.object({
  ...
  roasteryId: z.string().optional().default(""),
  estateId: z.string().optional().default(""),
  origin: z.string().optional().default(""),
  location: z.string().optional().default(""),
  roastLevel: z.string().optional().default(""),
  brewType: z.string().optional().default(""),
  processMethod: z.string().optional().default(""),
  flavorNotes: z.string().optional().default(""),
  coffeeWeight: z.coerce.number().positive().optional().nullable(),
  shotWeight: z.coerce.number().positive().optional().nullable(),
  brewTime: z.coerce.number().int().positive().optional().nullable(),
  grindSize: z.string().optional().default(""),
  grinderType: z.string().optional().default(""),
  rating: z.coerce.number().min(0).max(10).optional().nullable(),
  bestHad: z.string().optional().default(""),
  nicheRecipe: z.string().optional().default(""),
  tasteNotes: z.string().optional().default(""),
...
export async function createEntry(formData: FormData) {
  ...
  const data = entrySchema.parse({
    ...
    shotWeight: raw.shotWeight || null,
  ...
  await db.insert(coffeeEntries).values({
    ...
    roasteryId: data.roasteryId || null,
